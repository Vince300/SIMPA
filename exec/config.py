...
#DATA
config['data']=dict()
if (raw_input("Connaissez-vous des données qui seraient utiles au simpa.hit.simpa.drivergen.crawler (ex: valeur utile à entrer dans un champ de recherche, etc.) ? [o/N]\n\t").lower()=="o"):
    wantMore=True
    while wantMore:
