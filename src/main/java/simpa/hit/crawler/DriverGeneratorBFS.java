...
public class DriverGeneratorBFS extends DriverGenerator {
	...
	protected int crawlInput(WebInput start) {
		...
		while (!inputsToCrawlAfter.isEmpty()
				&& depth < MAX_DEPTH
				&& System.currentTimeMillis() - startingTime < simpa.hit.main.drivergen.Options.LIMIT_TIME) {
			depth++;
		...
		if (System.currentTimeMillis() - startingTime > simpa.hit.main.drivergen.Options.LIMIT_TIME){
