package simpa.hit.stats.attribute;

import simpa.hit.stats.Units;
...
public class Attribute <T extends Comparable<T>> {
	...
	public final static Attribute<String> AUTOMATA =				new Attribute<String>(	"infered simpa.hit.automata",					Units.NO_UNITS,	false, 	true, 	false);
	...
	public final static Attribute<Integer>LEARNER_NUMBER =			new Attribute<Integer>(	"number of sub-simpa.hit.learner",			Units.LEARNER,	false,	true,	false);
