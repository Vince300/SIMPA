...
import simpa.hit.learner.efsm.table.LiControlTableItem;
import simpa.hit.learner.efsm.table.LiControlTableRow;
import simpa.hit.learner.efsm.table.LiDataTable;
import simpa.hit.learner.efsm.table.LiDataTableItem;
import simpa.hit.learner.efsm.table.LiDataTableRow;
import simpa.hit.learner.efsm.table.NBP;
import simpa.hit.learner.efsm.table.NDF;
import simpa.hit.learner.efsm.table.NDV;
import simpa.hit.learner.efsm.tree.ZXObservationNode;
import simpa.hit.learner.mealy.table.LmControlTable;
import simpa.hit.learner.mealy.table.LmControlTableItem;
import simpa.hit.learner.mealy.table.LmControlTableRow;
import simpa.hit.learner.mealy.tree.ZObservationNode;
import simpa.hit.main.simpa.Options;
import simpa.hit.main.simpa.SIMPA;
import simpa.hit.tools.Base64;
...
public class HTMLLogger implements ILogger {
	...
	public void logStat(String s) {
		try {
			...
			writer.write("<div id=\"simpa.hit.stats\">\n");
