...
import simpa.hit.drivers.mealy.MealyDriver.UnableToComputeException;
...
public class RivestSchapireLearner extends Learner {
	...
	protected Lock lock = new ReentrantLock();//When a simpa.hit.learner is computing, it take the lock. When the lock is free, the simpa.hit.main thread try to notify a stateDriver
