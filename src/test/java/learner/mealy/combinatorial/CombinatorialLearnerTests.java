...
public class CombinatorialLearnerTests extends DotDriverBasedTestClass {
    ...
    @Ignore()
    public void runTest() {
        CombinatorialLearnerWithOutput CombinatorialLearner = new CombinatorialLearnerWithOutput(currentTestDriver);
        CombinatorialLearner.learn();
        assertEquivalence((Mealy)CombinatorialLearner.getLastConjecture());
    }
    ...
    /**
     * Initializes a new instance of a CombinatorialLearner test.
     * @param graphFile The file being tested
     * @param name Test name
     */
    public CombinatorialLearnerTests(File graphFile, @SuppressWarnings("unused") String name) {
