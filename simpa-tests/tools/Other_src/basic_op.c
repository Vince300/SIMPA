...
//#ifdef _USE_CW_PROTO_
//#ifdef SIMUL 
//#include <prototype.c>		// Now we use USE_CW_EMULATE_PROTO when compiling
//#endif
//#else


#ifndef _USE_CW_PROTO_
...
Word16 mult_r(Word16 var1, Word16 var2)
  {
   ...
   var_out = saturate(L_produit_arr);
   return(var_out);
  }
