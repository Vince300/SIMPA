#line 1 "D:\\cygwin\\home\\qatools\\new_qa\\testtools\\excel\\reporting\\src\\main.c"	/* stack depth 0 */
...
#line 1 "D:\\cygwin\\home\\qatools\\new_qa\\testtools\\excel\\reporting\\src\\util.h"	/* stack depth 2 */
#line 39
...
void errlog(char *s1, ...) {
        va_list	par_list	= 0L ;
        par_list = (va_list) ((long) (& s1) + ((((long) (& s1 + 1) - (long) (& s1))+3)/4*4)) ;
        vfprintf(log_file, s1, par_list);
        vfprintf((&__files[2]) ,   s1, par_list);
        ((void) 0) ;
...
int main(int argc, char *argv[]) {
        ...
        while(--argc > 0) {
                ...
                if (strcmpil((*argv), "-cc") == 0) {
                        if (--argc > 0) {
                               ...
                               if         (strcmpil((*argv), "gcc")       == 0) { cc=e_gcc       ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "scc")       == 0) { cc=e_scc       ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "ppc")       == 0) { cc=e_ppc       ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "mwccarm")   == 0) { cc=e_mwccarm   ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "armcc")     == 0) { cc=e_armcc     ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "gccarm")    == 0) { cc=e_gccarm    ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "win32_x86") == 0) { cc=e_win32_x86 ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "dsp56800e") == 0) { cc=e_dsp56800e ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "mac_ppc")   == 0) { cc=e_mac_ppc   ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else if (strcmpil((*argv), "dsp56800")  == 0) { cc=e_dsp56800  ; fprintf((&__files[2]) , "-cc %s OK\n", *argv);
                               } else {
                               ...
                               fprintf((&__files[2]) , "-cc parameter is missing.\n");
                               params_error = 1;
                        }
                        ...
                        if (--argc > 0) {
                        	...
                        	out_fname = strdup(*argv);
                               ...
                               fprintf((&__files[2]) , "Always_Exit OK\n");
                               Always_Exit=1;
                }
                else if (*argv[0] == '-') {
        ...
        xml_open_worksheet("Speed");
        xml_output("Comparison for SPEED", comparison_data, nb_comparison_data);
        xml_close_worksheet();
        ...
        xml_open_worksheet("Size");
        xml_output("Comparison for SIZE", comparison_data, nb_comparison_data);
        xml_close_worksheet();
