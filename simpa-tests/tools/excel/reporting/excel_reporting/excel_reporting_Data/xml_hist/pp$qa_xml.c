#line 1 "D:\\cygwin\\home\\qatools\\new_qa\\testtools\\excel\\reporting\\src\\qa_xml.c"	/* stack depth 0 */
...
#line 11 "D:\\Program Files\\Metrowerks\\CodeWarrior_922\\MSL\\MSL_C\\MSL_Common\\Include\\stdarg.h"	/* stack depth 2 */
...
#line 17 "D:\\Program Files\\Metrowerks\\CodeWarrior_922\\MSL\\MSL_C\\MSL_Common\\Include\\cstdarg"	/* stack depth 3 */
...
static char     *xml_current[100 ]   = {0L } ;
...
void pxml_begin_tag(FILE *stream, const char tag_name[], ...) {
        ...
        pa = (va_list) ((long) (& tag_name) + ((((long) (& tag_name + 1) - (long) (& tag_name))+3)/4*4)) ;
        ...
        while ((p1 = (* ( char* *) (((pa) += (sizeof( char*) + ( 3) & ~( 3))) - (sizeof( char*) + ( 3) & ~( 3)))) ) != 0L ) {
                if ((p2 = (* ( char* *) (((pa) += (sizeof( char*) + ( 3) & ~( 3))) - (sizeof( char*) + ( 3) & ~( 3)))) ) != 0L ) {
                        p2 = strdup(p2) ;
                        no_quote_surr(p2) ;
                        fputs(" ",      stream) ;
                        fputs(p1,       stream) ;
...
void pxml_end_tag(FILE *stream, const char tag_name[]) {
        ...
        if (xml_level >= 0) {
                ...
                if (strcasecmp(tag_name, current) != 0) {
                        fprintf((&__files[2]) , "WARNING: closing %s instead of %s.\n", tag_name, current ) ;
                }
                free(current) ;
        }
        else {
                fprintf((&__files[2]) , "WARNING: no tag to close\n") ;
        }
        fflush(stream);
        return ;
}
...
void pxml_push_tags(const char tag_name[], ...) {
        ...
        while (t != 0L ) {
                ...
                t = (* ( char * *) (((pa) += (sizeof( char *) + ( 3) & ~( 3))) - (sizeof( char *) + ( 3) & ~( 3)))) ;
        }
...
void pxml_atomic_element(FILE *stream, const char name[], const char value[], ...) {
        ...
        pa = (va_list) ((long) (& value) + ((((long) (& value + 1) - (long) (& value))+3)/4*4)) ;
